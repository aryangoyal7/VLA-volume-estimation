...
from lang_sam.models.gdino import DEFAULT_GDINO_MODEL_ID, GDINO
...
class LangSAM:
    def __init__(
        ...
        gdino_model_ckpt_path: str | None = None,
        gdino_processor_ckpt_path: str | None = None,
        gdino_model_id: str = DEFAULT_GDINO_MODEL_ID,
        device=DEVICE,
    ):
        ...
        self.gdino.build_model(
            model_ckpt_path=gdino_model_ckpt_path,
            processor_ckpt_path=gdino_processor_ckpt_path,
